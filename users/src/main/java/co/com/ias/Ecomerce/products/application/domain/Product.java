...
public class Product {
    private final IdentificationNumber idProduct;
    ...
    public Product(IdentificationNumber idProduct,NonEmptyString name, NonEmptyString description, NonEmptyString basePrice, NonEmptyString taxRate, NonEmptyString inventoryQuantity, ProductStatus productStatus) {
    ...
    public static Validation<InputDataError, Product> parseProduct(
        ...
        var porductIdValidation = IdentificationNumber.parse(
                idProduct,
                "idProduct"
        );
    ...
    public IdentificationNumber getIdProduct() {
        return idProduct;
    }

package co.com.ias.eComerce.users.infraestructure.codecs.json;
...
public class IdentificationNumberCodec {
    ...
    @Override
    public void serialize(IdentificationNumber identificationNumber, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException, IOException {
